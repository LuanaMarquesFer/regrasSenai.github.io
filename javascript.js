...
" Não é permitido utilizar recursos de comunicação instantânea (MSN, salas de bate-papo, didático-pedagógicas;",
" É proibido perturbar o ambiente com brincadeiras, algazarras e/ou qualquer outra atividade alheia às atividades didático-pedagógicas como também exercer atividades não relacionadas com o usoespecífico deste Laboratório;",
" Não é permitido trocar cabos ou equipamentos periféricos e/ou acessórios (teclados, mouses, etc.)Caso algum equipamento apresente defeito ou não ligue, informar o instrutor para que essecomunique a área de TI responsável por manutenções.",
...
" Desmontar qualquer equipamento ou acessório dos Laboratórios de Informática, sob qualquer pretexto, assim como remover equipamentos d local a eles destinados (mesmo dentro do recinto), desde que não esteja previsto em atividades didático-pedagógicas",
...
if (index >= regras.length){
	index= 0;
}
	atualizarRegra();
}
function passarRegras(){
index--;
...
function atualizarRegra(){
	...
	lblContador.innerHTML = regras[index];
